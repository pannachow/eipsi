  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <Typography variant="h3" paragraph>
        Drag and Drop the human emoji with the same number of times as you have discussed Evidence
        Informed Practices with different people within the last 2 months.
      </Typography>
